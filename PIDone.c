...
extern void PIDone_derivatives(void);
...
void PIDone_step(void)
{
   ...
   *  Sum: '<S1>/SumD'
   */
  rtDW.FilterCoefficient = ((10.0 - rtX.StateSpace_CSTATE[1]) * 3.0 -
   ...
   *  Sum: '<Root>/Sum2'
   */
  rtDW.Sum = ((10.0 - rtX.StateSpace_CSTATE[1]) * 10.0 + rtX.Integrator_CSTATE)
   ...
   *  Sum: '<Root>/Sum2'
   */
  rtDW.IntegralGain = (10.0 - rtX.StateSpace_CSTATE[1]) * 5.0;
  if (rtmIsMajorTimeStep(rtM)) {
...
void PIDone_derivatives(void)
{
  ...
  _rtXdot->StateSpace_CSTATE[0] += -0.8 * rtX.StateSpace_CSTATE[0];
  _rtXdot->StateSpace_CSTATE[0] += -rtX.StateSpace_CSTATE[1];
  _rtXdot->StateSpace_CSTATE[1] += rtX.StateSpace_CSTATE[0];
  _rtXdot->StateSpace_CSTATE[0] += rtDW.Sum;
